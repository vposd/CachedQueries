...
/// <summary>
/// Provides extension methods for configuring caching services and integrating CachedQueries into the application's dependency injection container.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Configures caching services and strategies for the application by registering the required dependencies into the service collection.
    /// </summary>
    ...
    /// <summary>
    /// Initializes the caching system by configuring the <see cref="CacheManagerContainer"/> with the application's service provider.
