...
/// <summary>
///     Defines the contract for a strategy that manages the execution of cache entries, including retrieval and storage
///     logic.
/// </summary>
public interface ICacheEntryStrategy
{
    ...
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the cached result of type T, or null if
