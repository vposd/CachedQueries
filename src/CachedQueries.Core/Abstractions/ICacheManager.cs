...
public interface ICacheManager
{
    ...
    /// <summary>
    /// Gets the strategy used for handling individual cache entries, including rules for adding, retrieving, and expiring cached items.
    /// </summary>
    ICacheEntryStrategy CacheEntryStrategy { get; }

    /// <summary>
    /// Gets the service responsible for invalidating cache entries based on specific conditions, such as time-based or event-based expiration.
    /// </summary>
    ...
    /// <summary>
    /// Gets the provider responsible for handling the context in which cache operations occur, such as managing scoped or shared cache contexts.
    /// </summary>
