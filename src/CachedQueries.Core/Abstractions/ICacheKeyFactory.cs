...
public interface ICacheKeyFactory
{
    ...
    /// <param name="query">
    ///     The query parameter used to generate the cache key. This should be an IQueryable representing the
    ///     data source.
    /// </param>
    /// <param name="tags">An array of strings representing linking tags that can be used for further cache invalidation.</param>
    /// <returns>
    ///     A string representing the unique cache key for the provided query and tags. This key will be used to store and
