...
public static class QueryableCacheExtensions
{
    ...
    public static Task<List<T>> ToListCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().ToListAsync(cancellationToken);
    }
    ...
    public static Task<List<T>> ToListCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable(options).ToListAsync(cancellationToken);
    }
    ...
    public static Task<T?> FirstOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().FirstOrDefaultAsync(cancellationToken);
    }
    ...
    public static Task<T?> FirstOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().FirstOrDefaultAsync(predicate, cancellationToken);
    }
    ...
    public static Task<T?> FirstOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable(options).FirstOrDefaultAsync(predicate, cancellationToken);
    }
    ...
    public static Task<T?> SingleOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().SingleOrDefaultAsync(cancellationToken);
    }
    ...
    public static Task<T?> SingleOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().SingleOrDefaultAsync(predicate, cancellationToken);
    }
    ...
    public static Task<T?> SingleOrDefaultCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable(options).SingleOrDefaultAsync(predicate, cancellationToken);
    }
    ...
    public static Task<int> CountCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().CountAsync(cancellationToken);
    }
    ...
    public static Task<int> CountCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable(options).CountAsync(cancellationToken);
    }
    ...
    public static Task<bool> AnyCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().AnyAsync(cancellationToken);
    }
    ...
    public static Task<bool> AnyCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable().AnyAsync(predicate, cancellationToken);
    }
    ...
    public static Task<bool> AnyCachedAsync<T>(
        ...
        where T : class
    {
        return query.Cacheable(options).AnyAsync(predicate, cancellationToken);
    }
}
